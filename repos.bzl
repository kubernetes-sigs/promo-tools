...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:2RJXJuTMac944e419pJJJ3mOJBcr3A3M6SN6wQKZ/Gs=",
        version = "v5.4.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:mSqlqz9BDpfbuxs0IWoRxqbyz7GfWQHLsDH47n89jCw=",
        version = "v0.8.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:K/CJGaWH8poLrg/NpNQzHU60T/FiFtgZl2w8JhZequA=",
        version = "v1.3.0",
    )
    ...
    go_repository(
        name = "com_github_spiegel_im_spiegel_errs",
        build_file_generation = "on",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/spiegel-im-spiegel/errs",
        sum = "h1:v4amEwRDqRWjKHOILQnJSovYhZ4ZttEnBBXNXEzS6Sc=",
        version = "v1.0.2",
    )
    go_repository(
        name = "com_github_spiegel_im_spiegel_go_cvss",
        build_file_generation = "on",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/spiegel-im-spiegel/go-cvss",
        sum = "h1:A+S9I01wkiEo6e66xFbxtz9LfXdsGUr5FppYozUAmmI=",
        version = "v0.4.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:rpOZQjxVJGW/ch+Jy4j7W4o7BB1mxkXJNVGuplZ7PUs=",
        version = "v0.43.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:NSaHgaeJFCtWXCBkBKXw0rhgMuJ0VoE9FB5mWldcrQ4=",
        version = "v1.3.7",
    )
    ...
    go_repository(
        ...
        sum = "h1:VX4qLsym8T94ey4zBPHCT3jVL4vvuHZ0rRJ5B+Rk0QE=",
        version = "v0.8.1-0.20210526071921-fa4837a72cf9",
    )
    go_repository(
    ...
    go_repository(
        name = "io_k8s_sigs_zeitgeist",
        build_file_generation = "on",
        build_file_proto_mode = "disable_global",
        importpath = "sigs.k8s.io/zeitgeist",
        sum = "h1:vCdINPGoPEa9/jRUFBuIorptKZe/KoTqf8hKdyeLX6M=",
        version = "v0.3.0",
    )
