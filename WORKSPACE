...
go_repository(
    ...
    sum = "h1:a+2dmZmBh6X6ieBAr9eO+jVcVnaB0M5cMQNvAfTn35s=",
    version = "v0.0.0-20190913191148-bb2eda47dcc0",
)
...
go_repository(
    ...
    sum = "h1:X3j64GFUkgT5sCzlgbirLbyqrqDXJ2DLmf5Yn2Muc/E=",
    version = "v0.0.0-20190913075813-344bcc0201c9",
)
